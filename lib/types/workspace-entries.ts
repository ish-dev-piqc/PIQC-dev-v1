...
export type CreateWorkspaceEntryInput = z.infer<typeof CreateWorkspaceEntrySchema>;
...
export type UpdateWorkspaceEntryInput = z.infer<typeof UpdateWorkspaceEntrySchema>;

export const ConfirmRiskContextSchema = z.object({
  actorId: z.string().uuid(),
});

export type ConfirmRiskContextInput = z.infer<typeof ConfirmRiskContextSchema>;
