...
export type TrackedObjectType =
  ...
  | 'SITE_MODULE_MAPPING_OBJECT'
  | 'SITE_SCOPE_OBJECT'
  | 'DOCUMENT_REQUEST_OBJECT'
  ...
  | 'AGENDA_OBJECT'
  | 'CHECKLIST_OBJECT'
  | 'INTERNAL_NOTIFICATION_OBJECT'
  | 'EVIDENCE_GAP_SUMMARY_OBJECT'
  | 'FINDINGS_REPORT_OBJECT'
  | 'AUDIT_CERTIFICATE_OBJECT'
  | 'REPORT_DRAFT_OBJECT'
  | 'ISSUE_OBJECT'
  | 'CAPA_OBJECT';
