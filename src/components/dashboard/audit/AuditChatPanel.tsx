        ...
        <div className="sticky top-0 z-10 bg-[#F8FAFC]/95 dark:bg-[#020617]/95 backdrop-blur px-5 py-3 border-b border-[#E2E8F0] dark:border-white/5 flex items-start justify-between gap-3">
          <div className="min-w-0 flex-1">
            <div className="flex items-center gap-2">
              <span className="text-brand-600 dark:text-brand-300 flex-shrink-0">
                <PiqcMark size={14} />
              </span>
              <h2
                  ...
                  >
                    ...
                    {isAssistant && onAssistantWriteback && !writebackOpen && (
                      ...
                      >
                        <button
                          ...
                          className="font-medium underline underline-offset-2 decoration-brand-600/40 hover:decoration-brand-600 hover:text-fg-heading"
                    ...
                    {isAssistant && writebackOpen && writebackPending && (
                      <div
                        ...
                        className="mt-2 max-w-[85%] rounded-md border border-brand-600/30 dark:border-brand-600/40 bg-[#F2F2F2] dark:bg-white/[0.04] px-3 py-2.5 text-xs text-fg-heading"
                      >
                        ...
                        <div className="flex items-center gap-2">
                          ...
                          <button
                            ...
                            className="text-[11px] font-semibold px-2.5 py-1 rounded-md bg-brand-600 text-white hover:bg-[#3f5f8e] disabled:opacity-60 disabled:cursor-not-allowed"
                          >
        ...
        <div className="border-t border-[#E2E8F0] dark:border-white/5 bg-[#F8FAFC] dark:bg-[#020617] px-5 py-3">
          <div className="flex items-end gap-2">
            <textarea
              ...
              className="flex-1 resize-none rounded-md border border-[#E2E8F0] dark:border-white/10 bg-white dark:bg-[#0F172A] text-sm text-fg-heading placeholder:text-fg-muted px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-600/30 disabled:opacity-60"
            />
            <button
              type="button"
              onClick={handleSend}
              ...
              className="inline-flex items-center justify-center w-9 h-9 rounded-md bg-brand-600 text-white hover:bg-[#3f5f8e] disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex-shrink-0"
            >
              <Send size={14} />
            </button>
          </div>
