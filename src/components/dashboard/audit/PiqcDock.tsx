  ...
  return (
    <button
      ...
      className={[
        ...
        isLight
          ? 'bg-white border border-[#017BC8]/25 text-[#334155] shadow-[0_8px_24px_-8px_rgba(74,111,165,0.35)] hover:shadow-[0_12px_32px_-8px_rgba(74,111,165,0.45)] hover:border-[#017BC8]/40'
