...
// Hoisted to the shared non-mode lib (src/lib/winAnsiSafe.ts) when the
// deliverables exporters ported this fix — one transliteration table, no
// cross-lane duplication. Re-exported so this module's public surface (and
