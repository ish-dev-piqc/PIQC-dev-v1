...
//      Generate section 5.3.x addendum questions from this audit's
//      VendorServiceMappingObject entries.
//      Default: incremental (appends new questions for un-covered mappings).
